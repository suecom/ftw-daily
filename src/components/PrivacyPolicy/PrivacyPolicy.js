...
const PrivacyPolicy = props => {
  ...
  return (
    <div className={classes}>
      ...
      <p>
        OldenCars Ltd<br/>
        www.oldencars.com<br/>
        support (at) oldencars.com
      </p>
      ...
      <p>
        ...
        United Kingdom<br/>
        +44-7873-124107<br/>
        anna (at) oldencars.com
      </p>

      <h2>Name or the register</h2>
      <p>
        User register of the OldenCars service
      </p>
      ...
      <p>
        ...
        Details can be used for communication between service providers and users and also 
        for direct communication between users. Some personal details are visible on the profile 
        page of the user, but those details are voluntary (except name).<br/>
        <br/>
        The handling of personal details is not outsourced, but the register data is stored on a 
        server that is rented from a third party company.
      </p>
      ...
      <h2>Data Processor (or Service Providers)</h2>
      <p>
         Data Processor (or Service Provider) means any person (other than an employee of the 
         Data Controller) who processes the data on behalf of the Data Controller.<br/>
         <br/>
      ...
      <p>
        ...
        <ul>
          ...
          <li>Driving Licence information (if applicable)</li>
          <li>Vehicle registration (if applicable)&nbsp;</li>
          <li>Face images for security verification</li>
        </ul>
        Personal information is collected for the main purpose of verification which is a 
        requirement for the security of OldenCars users.<br/>
        <br/>
      ...
      <p>
        ...
        when you access the Service by or through a mobile device ("Usage Data").<br/>
        <br/>
      ...
      <p>
        ...
        certain information.</p><p>Cookies are files with small amount of data which may include an 
      ...
      <h2>Use of Data</h2>
      <p>
        OldenCars Ltd uses the collected data for various purposes, including but not limited to:<br/>
        <ul>
          <li>To provide and maintain our Service</li>
          <li>To verify members’ identity</li>
          <li>To make or receive payments to/from verified members</li>
      ...
      <p>
        OldenCars Ltd will retain your Personal Data only for as long as is necessary for the 
        ...
        <br/>
        OldenCars Ltd will also retain Usage Data for internal analysis purposes. Usage Data is 
      ...
      <p>
        ...
        located outside of your province, country or other governmental jurisdiction where the data 
        protection laws may differ than those from your jurisdiction.<br/>
        <br/>
        If you are located outside the United Kingdom and choose to provide information to us, 
        please note that we transfer the data, including Personal Data, to the United Kingdom and 
        process it there.<br/>
        <br/>
        Your consent to this Privacy Policy followed by your submission of such information represents 
        your agreement to that transfer.<br/>
        <br/>
        OldenCars Ltd will take all steps reasonably necessary to ensure that your data is treated 
      ...
      <p>
        If OldenCars Ltd is involved in a merger, acquisition or asset sale, your Personal Data may 
      ...
      <p>
        Under certain circumstances, OldenCars Ltd may be required to disclose your Personal Data 
      ...
      <p>
        OldenCars Ltd may disclose your Personal Data in the good faith belief that such action 
        is necessary to:<br/>
        <ul>
          <li>To comply with a legal obligation</li>
          <li>To protect and defend the rights or property of OldenCars Ltd</li>
      ...
      <h2>Your Rights</h2>
      <p>
        OldenCars Ltd aims to take reasonable steps to allow you to correct, amend, delete, or 
        limit the use of your Personal Data.<br/>
        <br/>
        Whenever made possible, you can update your Personal Data directly within your account settings 
        section. If you are unable to change your Personal Data, please contact us to make the 
        required changes.<br/>
        <br/>
        If you wish to be informed what Personal Data we hold about you and if you want it to be removed 
        from our systems, please contact us.<br/>
        <br/>
        In certain circumstances, you have the right:<br/>
        <ul>
        ...
        You have the right to data portability for the information you provide to OldenCars Ltd. 
        You can request to obtain a copy of your Personal Data in a commonly used electronic format 
        so that you can manage and move it<br/>
        <br/>
      ...
      <p>
        ...
        and are obligated not to disclose or use it for any other purpose. These services include but 
        are not limited to:
      </p>
      ...
      <p>
        ...
        contextualise and personalise the ads of its own advertising network.<br/>
        <br/>
      ...
      <p>
        ...
        payment processors whose use of your personal information is governed by their Privacy Policy. 
      ...
      <h2>Contact Us</h2>
      <p>
        If you have any questions about this Privacy Policy, please contact us: admin@oldencars.com
      </p>
    </div>
  );
};
